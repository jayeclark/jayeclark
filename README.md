...
At the moment I'm in the middle of an [Open Source Challenge](https://github.com/jayeclark/jayeclark/blob/main/opensourcechallenge.md) to open valid, useful pull requests against **100 open source projects in 100 days** - so I may not have the free time to contribute more than once to a repository until I complete that challenge. But please feel free to reach out if you like my work and would like additional contributions from me in the future!
