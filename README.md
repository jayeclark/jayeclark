...
I'm a career-transitioning full stack developer (moving from solo backend dev to team full-stack or front end development) with nearly a decade of relevant business and teaching experience. 
...
The talent management agency I worked for shut down three months into the pandemic. I did some contract development work while searching for a full time job in software development, but soon realized I couldn't get the kind of role I wanted yet - there were too many gaps in my technical knowledge from my years as a solo developer using older/obscure technologies. I rented out my house, hit the road as a digital nomad (new experiences are the PERFECT backdrop for learning), and embarked on a 12-month training program of self study accompanied and four professional certificates: [Intro to Computer Science](https://www.edx.org/course/introduction-computer-science-harvardx-cs50x), [Full-stack Web Development](https://xpro.mit.edu/programs/program-v1:xPRO+PCCx+R1/), [Data Science](https://www.edx.org/professional-certificate/harvardx-data-science), and [Machine Learning](https://learn-xpro.mit.edu/machine-learning).  
